...
#define FTS_ERASE_APP_DELAY		1350
#define FTS_ERASE_SECTOR_DELAY		60
#define FTS_RETRIES_ERASE		50
#define FTS_RETRIES_DELAY_ERASE		400
...
struct upgrade_func {
	...
	u8 *pramboot;
	u32 pb_length;
	int (*init)(struct fts_upgrade *upg, u8 *fw, u32 fw_length);
	int (*write_pramboot_private)(struct fts_upgrade *upg);
	int (*upgrade)(struct fts_upgrade *upg, u8 *fw, u32 fw_length);
	int (*get_hlic_ver)(struct fts_upgrade *upg, u8 *lic);
	int (*lic_upgrade)(struct fts_upgrade *upg, u8 *lic, u32 lic_length);
	int (*param_upgrade)(struct fts_upgrade *upg, u8 *fw, u32 fw_length);
	int (*force_upgrade)(struct fts_upgrade *upg, u8 *fw, u32 fw_length);
};
 ...
 *****************************************************************************/
extern struct upgrade_func upgrade_func_ft3418;
