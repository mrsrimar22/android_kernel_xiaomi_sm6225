...
#ifndef __TCPC_EVENT_BUF_H__
#define __TCPC_EVENT_BUF_H__
...
static inline bool pd_event_ctrl_msg_match(struct pd_event *pd_event, u8 msg)
{
	return pd_event_msg_match(pd_event, PD_EVT_CTRL_MSG, msg);
}

static inline bool pd_event_data_msg_match(struct pd_event *pd_event, u8 msg)
{
	return pd_event_msg_match(pd_event, PD_EVT_DATA_MSG, msg);
}

static inline bool pd_event_hw_msg_match(struct pd_event *pd_event, u8 msg)
{
	return pd_event_msg_match(pd_event, PD_EVT_HW_MSG, msg);
}

static inline bool pd_event_pe_msg_match(struct pd_event *pd_event, u8 msg)
{
	return pd_event_msg_match(pd_event, PD_EVT_PE_MSG, msg);
}

static inline bool pd_event_timer_msg_match(struct pd_event *pd_event, u8 msg)
{
...
static inline bool pd_event_ext_msg_match(struct pd_event *pd_event, u8 msg)
{
