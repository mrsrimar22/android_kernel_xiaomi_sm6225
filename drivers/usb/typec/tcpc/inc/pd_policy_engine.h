...
#ifndef __PD_POLICY_ENGINE_H__
#define __PD_POLICY_ENGINE_H__
...
#define PE_STATE_FLAG_BACK_READY_IF_RECV_WAIT		BIT(0)
#define PE_STATE_FLAG_BACK_READY_IF_RECV_REJECT		BIT(1)
#define PE_STATE_FLAG_BACK_READY_IF_SR_TIMER_TOUT	BIT(2)
#define PE_STATE_FLAG_BACK_READY_IF_TX_FAILED		BIT(3)
#define PE_STATE_FLAG_HRESET_IF_SR_TIMEOUT		BIT(4)
#define PE_STATE_FLAG_HRESET_IF_TX_FAILED		BIT(5)
#define PE_STATE_FLAG_IGNORE_UNKNOWN_EVENT		BIT(6)
#define PE_STATE_FLAG_ENABLE_SENDER_RESPONSE_TIMER	BIT(7)
...
#define PE_STATE_FLAG_BACK_READY_IF_RECV_GOOD_CRC	BIT(0)
#define PE_STATE_FLAG_BACK_READY_IF_DPM_ACK		BIT(1)
#define PE_STATE_FLAG_DPM_ACK_IMMEDIATELY		BIT(7)
...
#define VDM_STATE_FLAG_ENABLE_VDM_RESPONSE_TIMER	BIT(0)
#define VDM_STATE_FLAG_DPM_ACK_IMMEDIATELY		BIT(4)
#define VDM_STATE_FLAG_BACK_READY_IF_DPM_ACK		BIT(6)
#define VDM_STATE_FLAG_BACK_READY_IF_RECV_GOOD_CRC	BIT(7)
...
static inline void pe_send_swap_request_entry(struct pd_port *pd_port, u8 msg)
{
