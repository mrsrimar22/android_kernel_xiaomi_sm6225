...
extern int tcpc_typec_handle_ctd(struct tcpc_device *tcpc, enum tcpc_cable_type cable_type);
#endif /* CONFIG_CABLE_TYPEC_DETECTION */

#define typec_get_cc1()	tcpc->typec_remote_cc[0]
#define typec_get_cc2()	tcpc->typec_remote_cc[1]
#define typec_get_cc_res()	(tcpc->typec_polarity ? typec_get_cc2() : typec_get_cc1())
