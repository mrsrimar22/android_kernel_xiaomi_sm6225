...
#ifndef __LINUX_TCPCI_TYPEC_H__
#define __LINUX_TCPCI_TYPEC_H__
#include "tcpci.h"
#include "tcpci_rt1711h.h"
...
int tcpc_typec_change_role(struct tcpc_device *tcpc, u8 typec_role, bool postpone);
