...
#ifndef __STD_TCPCI_V10_H__
#define __STD_TCPCI_V10_H__
 ...
 */
#define TCPC_V10_REG_ALERT_VENDOR_DEFINED		BIT(15)
...
#define TCPC_V10_REG_TCPC_CTRL_EN_LOOK4CONNECTION_ALERT	BIT(6)
#define TCPC_V10_REG_TCPC_CTRL_EN_WDT			BIT(5)
...
#define TCPC_V10_REG_VBUS_MONITOR			BIT(6)
#define TCPC_V10_REG_BLEED_DISC_EN			BIT(3)
#define TCPC_V10_REG_FORCE_DISC_EN			BIT(2)
...
#else
#define TCPC_V10_REG_TRANSMIT_SET(retry, type) \
		((void)(retry), (PD_RETRY_COUNT << 4 | (type)))
#endif	/* CONFIG_USB_PD_REV30 */

#endif	/* __STD_TCPCI_V10_H__ */
