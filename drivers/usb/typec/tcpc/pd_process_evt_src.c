...
static bool pd_process_ctrl_msg_good_crc(struct pd_port *pd_port,
...
static bool pd_process_ctrl_msg_get_sink_cap(struct pd_port *pd_port,
					     struct pd_event *pd_event)
{
...
static bool pd_process_hw_msg_vbus_present(struct pd_port *pd_port,
					   struct pd_event *pd_event)
{
	switch (pd_port->pe_state_curr) {
	case PE_SRC_STARTUP:
 ...
 */
static bool pd_process_timer_msg_source_start(struct pd_port *pd_port,
					      struct pd_event *pd_event)
{
...
static bool pd_process_timer_msg_source_cap(struct pd_port *pd_port,
					    struct pd_event *pd_event)
{
...
static bool pd_process_timer_msg_no_response(struct pd_port *pd_port,
					     struct pd_event *pd_event)
{
