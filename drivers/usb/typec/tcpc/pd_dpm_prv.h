...
#ifndef __PD_DPM_PRV_H__
#define __PD_DPM_PRV_H__
...
static inline bool dpm_check_data_msg_event(struct pd_port *pd_port, u8 msg)
{
	return pd_event_data_msg_match(pd_get_curr_pd_event(pd_port), msg);
}

#ifdef CONFIG_USB_PD_REV30
static inline bool dpm_check_ext_msg_event(struct pd_port *pd_port, u8 msg)
{
	return pd_event_ext_msg_match(pd_get_curr_pd_event(pd_port), msg);
}
#endif	/* CONFIG_USB_PD_REV30 */

static inline u8 dpm_vdm_get_ops(struct pd_port *pd_port)
{
	return pd_port->curr_vdm_ops;
}

static inline u16 dpm_vdm_get_svid(struct pd_port *pd_port)
{
...
struct svdm_svid_data *dpm_get_svdm_svid_data(struct pd_port *pd_port, u16 svid);
...
static inline bool svdm_dfp_inform_modes(struct pd_port *pd_port, u16 svid, bool ack)
{
	struct svdm_svid_data *svid_data;
...
static inline bool svdm_dfp_inform_exit_mode(struct pd_port *pd_port, u16 svid, u8 ops)
{
	struct svdm_svid_data *svid_data;
...
static inline bool svdm_dfp_inform_attention(struct pd_port *pd_port, u16 svid)
{
	struct svdm_svid_data *svid_data;
...
static inline bool svdm_ufp_request_enter_mode(struct pd_port *pd_port, u16 svid, u8 ops)
{
	struct svdm_svid_data *svid_data;
...
static inline bool svdm_ufp_request_exit_mode(struct pd_port *pd_port, u16 svid, u8 ops)
{
	struct svdm_svid_data *svid_data;
