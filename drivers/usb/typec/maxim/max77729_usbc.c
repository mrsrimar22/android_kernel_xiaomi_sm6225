...
static DEVICE_ATTR(fw_update, 0664,
...
int max77729_usbc_is_pd_verified(void)
{
	if (!g_usbc_data)
		return 0;

	return g_usbc_data->verifed;
}
EXPORT_SYMBOL(max77729_usbc_is_pd_verified);
