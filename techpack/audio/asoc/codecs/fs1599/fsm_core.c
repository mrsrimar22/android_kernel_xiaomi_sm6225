...
int fsm_parse_preset(const void *data, uint32_t size)
{
	...
	pr_info("date: %4d%02d%02d-%02d%02d", hdr->date.year, hdr->date.month, hdr->date.day, hdr->date.hour, hdr->date.min);
